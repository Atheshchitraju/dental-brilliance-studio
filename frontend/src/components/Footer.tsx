    ...
    <footer className="mt-32 border-t border-border bg-gradient-silver">
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              <Link to="/designers" className="hover:text-primary">
                Our Designers
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li>+91 821 721 6397</li>
            <li>
              NO 107, First Floor,4th Cross,36th Main Road, BHOOHBCL, KAS Officers Colony, BTM
              Layout 2nd Stage, Bengaluru, Karnataka 560068
            </li>
          </ul>
        </div>
      </div>
      <div className="border-t border-border py-6 text-center text-xs text-muted-foreground">
        ...
        <span className="block mt-2 text-sm text-muted-foreground">
          Developed & designed by <span className="font-semibold text-primary">Athesh C</span>
        </span>
      </div>
    </footer>
  );
