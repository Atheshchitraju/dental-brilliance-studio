...
export const Route = createFileRoute("/designers")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the senior 3D dental designers and master ceramists behind every 3D Digital Dental Designers restoration." },
      { property: "og:title", content: "Digital Dental Designers — 3D Digital Dental Designers Lab" },
      { property: "og:description", content: "Meet the senior 3D dental designers and master ceramists behind every 3D Digital Dental Designers restoration." },
    ],
  }),
  ...
  return (
    ...
    >
      <div className="aspect-[4/5] overflow-hidden bg-gradient-silver">
        <img src={img} alt={name} loading="lazy" width={768} height={896} className="h-full w-full object-cover" />
      </div>
      <div className="p-6">
